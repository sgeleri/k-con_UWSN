"""
    ...
    env.positions ──────────────► panel (a): where is everyone?
                                      │
    solution.node_energy_j ─────► colors + bottleneck=2
    solution.data_flow_packets ─► faint lines + dashed (1,2)/(2,0)
    solution.paths[2,*] ────────► solid blue 2→0
    solution.objective_energy_j ► title ε=0.431 kJ
                                      │
                                      ▼
                         PNGs + scenario_metadata.json
"""
